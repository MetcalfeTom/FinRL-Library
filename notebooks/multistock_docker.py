...
from torch.nn import ReLU, Softsign
...
model.learn(
    ...
    log_interval=1,
    tb_log_name="ppo_1024_5_more_ooc_penalty",
...
e_trade_gym = StockTradingEnv(
    df=trade, hmax=10, daily_information_cols=information_cols, print_verbosity=500
)
